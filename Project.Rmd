...
investment_indicators <- read_csv("Data/11_Direct_Investment-related_Indicators.csv")
...
####### Cleaning dataset 24_Climate-related_Diasters_Frequency#######
disasters_frequency <- read_csv("Data/24_Climate-related_Disasters_Frequency.csv")
