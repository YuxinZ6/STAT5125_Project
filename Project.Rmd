...
# Model Selection
Metrics used to evaluate the models are Mean Absolute Error (mae), Root Mean Squared Error (rmse), and residual Squared (rsq), each are a measure of deviation or error of predicted values from observed values. 


# Uncertainty Quantification
Validation of held-out data has been performed above for each model. Below gathers all the held-out metrics from above into one table. For now XG-boost is not included.
