...
{add which variable contributed the most --- extract from random forest, if we can maybe visualize the tree?}
...
With that said a suggestion for the future would be to include countries for a more comprehensive analysis. As the hyperparameter was tuned for random forest, the same can be done for k-nearest neighbor.
 ...
 --- 
"Can we conclude that:" Disaster frequency is highly correlated to CO2 emissions.
    Questions to answer of we can: Which sector and enterprise produced the most CO2?
 ---
