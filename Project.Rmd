...
```{r Line Graph: Count of Disaster by Year for Each Country}
...
```{r Line Graph: Aggregated Across Year}
...
```{r Poisson_Lasso: Fitting With Cross Validation}
...
```{r Poisson_Lasso: Display Result}
# showing results 
...
```{r Poisson_EN: Fitting with Cross Validation}
# cross validation on train dataset
